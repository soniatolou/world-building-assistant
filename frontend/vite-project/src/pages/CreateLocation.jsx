...
export default function CreateLocation() {
  ...
  async function handleSubmit(e) {
    e.preventDefault();
    if (!formData.location_name.trim() || !formData.location_description.trim()) return;
        ...
        <div className="relative z-10 flex flex-col flex-1 p-10">
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-8 w-full max-w-xl">
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-white/70 text-xs tracking-widest uppercase">
                  Type <span className="text-white/30">(optional)</span>
                </label>
                <input
                  type="text"
                  name="location_type"
              ...
              <div className="flex flex-col gap-2">
                <label className="text-white/70 text-xs tracking-widest uppercase">
                  Map <span className="text-white/30">(optional)</span>
                </label>
                <select
                  name="map_id"
