...
export default function SpeciesPage() {
    ...
    async function handleCreate() {
        if (!createForm.species_name.trim() || !createForm.species_description.trim()) return
        try {
                ...
                <div className="relative z-10 flex flex-col flex-1 p-10">
                    ...
                    {speciesList.length === 0 ? (
                        <div className="flex items-center justify-center min-h-[50vh]">
                            <p className="text-white/40 text-sm">No species yet. Create your first one!</p>
                        </div>
                    ) : (
                    ...
                    >
                        ...
                        <div className="flex gap-3 mt-8">
                            <button
                                ...
                                disabled={!createForm.species_name.trim() || !createForm.species_description.trim()}
                            ...
                            <button
                                onClick={() => { setShowCreateModal(false); setCreateForm({ species_name: "", species_description: "" }) }}
