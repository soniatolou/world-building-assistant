...
export default function CreateSpecies() {
    ...
    const [form, setForm] = useState({ species_name: "", species_description: "", image_url: "" })
    ...
    async function handleSubmit() {
        ...
        try {
            await createSpecies(worldId, {
                species_name: form.species_name.trim(),
                species_description: form.species_description || null,
            ...
            <div className="flex flex-1">
                ...
                <div className="relative z-10 flex flex-col flex-1 p-10">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <h1 className="text-3xl font-bold text-white tracking-widest uppercase">New Species</h1>
                    </div>
                        ...
                        <div className="flex flex-col gap-5">
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full bg-white/10 border rounded-md px-4 py-2 text-white placeholder-white/30 focus:outline-none focus:border-purple-500/50 ${error && !form.species_name.trim() ? "border-red-500/60" : "border-white/20"}`}
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={(e) => setForm((f) => ({ ...f, species_description: e.target.value }))}
